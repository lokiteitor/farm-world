// Manejadores de la cola que posee el modulo `workers`.
//
// Andamiaje creado por W3-A con la firma definitiva. Propietario del contenido: W5-B.
//
...
/**
 * Manejador de `WORKER_POOL_REFRESH`: renueva el pool de candidatos cada 48 horas de juego (GDD §102).
 *
